...
export const CASE_PROTOCOLS = [Protocol.EtherFi, Protocol.ArbitrumBridge]
...
export const ATTRIBUTES = [
  ...
  //   items: protocolInfo,
  // },
  { id: 'txn_count', name: 'TXN count', value: '4' },
  { id: 'gas_saved', name: 'Gas saved', value: '~28.8%' },
]
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              {
                tag: 'li',
                value: `Connect your Blocto wallet or register a new one directly through the
              "connect wallet"!`,
              },
            ],
          },
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              {
                tag: 'li',
                value: 'Specify the wallet address you want to bridge.',
              },
              {
                tag: 'li',
                value:
                  'Note: Leave ~0.001 $ETH for bridging, (remember to modify your input after clicking Max)',
              },
            ],
          },
        ],
    ...
    children: [
      {
        ...
        children: [
          ...
          {
            tag: '',
            value: ' Loyalty Points for first deposit.',
          },
        ],
      },
    ],
    ...
    children: [
            ...
            children: [
              {
                ...
                value: 'Ether.fi',
                props: {
                  href: 'https://twitter.com/ether_fi',
                  target: '_blank',
                  rel: 'noopener noreferrer nofollow',
                },
              },
      ...
      },
      {
        ...
        children: [
          {
            tag: '',
            value: 'Send weETH to Arbitrum via ',
          },
          {
            tag: 'span',
            value: '',
