...
const morphoVault = "0x95EeF579155cd2C5510F312c8fA39208c3Be01a8";
const vaultName = "Re7 USDT";
const morphoPageLink = "https://app.morpho.org/vault?vault=0x95EeF579155cd2C5510F312c8fA39208c3Be01a8";
const txCount = 2;

const tags = [{ title: TagTitle.Defi }, { title: TagTitle.Lending }, { title: TagTitle.Leverage }];

const re7UsdtCase: BatchCase = {
  id: "morpho_re7_usdt",
  name: "Morpho Series - One click to deposit on Re7 USDT Vault",
  description: "One Click to earn lending APY and $MORPHO rewards by Morpho’s strategy.",
