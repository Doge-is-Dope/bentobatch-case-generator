...
import BATCH_DETAILS, { CASE_PROTOCOLS, ATTRIBUTES } from "./eth.eth.emode.details";
...
const ethEModeCase: BatchCase = {
  id: "aave_eth_eth_emode",
  name: "Deposit ETH and borrow ETH on AAVE [E-Mode]",
  description: "One click to deposit ETH and borrow 85% equivalent value in ETH.",
  ...
  inputs: [
    ...
    },
    {
      ...
      description: "Percentage of the supplied ETH to be borrowed as ETH (Max: 85%)",
      validate: decimalValidator(0, BigInt(0), BigInt(85)),
    },
  ],
  previewTx: [
    {
