...
export const CASE_PROTOCOLS = [Protocol.Orbit]
...
const BATCH_DETAILS = [
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              {
                tag: 'li',
                value: 'Specify the number of times you want to repeat.',
              },
            ],
          },
          {
            tag: 'span',
            value:
              'You can repeatedly supply and borrow ETH from your funds. Each round, the Batch will supply all of your ETH and borrow up to 65% of it.',
          },
        ],
      },
      {
    ...
    children: [
      {
        tag: 'li',
        value:
          'Extra gas fee for activating smart wallet at first time on every chain.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      {
        tag: 'li',
        value: 'Supply ETH and mint oETH',
      },
      {
        tag: 'li',
        value: 'Borrow 65% ETH',
      ...
      {
        tag: 'li',
        value: 'Mint oETH with borrowed ETH',
      },
      {
        tag: 'li',
        value: 'Borrow 65% ETH',
