...
const BATCH_DETAILS = [
            ...
            children: [
              {
                tag: 'li',
                value:
                  'Ensure you have USDC.e and MATIC in your Blocto Wallet. Your wallet address can be found in the top right corner.',
              },
              {
                tag: 'li',
                value:
            ...
            children: [
              {
                tag: 'li',
                value:
                  'Specify the amount of USDC.e you wish to use for this Batch.',
              },
            ],
          },
        ],
  ...
  },
  {
    ...
    children: [
      {
        tag: 'li',
        value: 'Approve USDC.e',
      },
      {
        tag: 'li',
        value: 'Stake USDC.e to V3 vault',
      },
    ],
  },
]
