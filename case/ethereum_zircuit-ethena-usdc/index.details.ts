...
export const CASE_PROTOCOLS = [Protocol.Ethena, Protocol.Zircuit]
            ...
            children: [
              {
                tag: 'li',
                value:
                  'Ensure you have USDC and ETH(gas fee) in your Blocto Wallet. Your wallet address can be found in the top right corner.',
              },
              {
                tag: 'li',
                value:
