...
export const CASE_PROTOCOLS = [Protocol.Lido, Protocol.EigenPie]
...
const BATCH_DETAILS = [
  ...
  },
  {
    ...
    children: [
      {
        tag: 'li',
        value: 'Deposit ETH into Lido smart contract to get $stETH',
      },
      {
        tag: 'li',
        value: 'Approve $stETH to Eigenpie restaking',
      },
      {
        tag: 'li',
        value: 'Deposit $stETH into Eigenpie',
      },
    ],
  },
]
