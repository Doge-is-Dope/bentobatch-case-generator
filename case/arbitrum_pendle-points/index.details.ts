...
export const CASE_PROTOCOLS = [Protocol.Pendle, Protocol.Renzo];
const protocolInfo = CASE_PROTOCOLS?.map((protocol) => PROTOCOLS_CONSTANT[protocol]);

export const ATTRIBUTES = [
  { id: "txn_count", name: "TXN count", value: "2" },
  { id: "gas_saved", name: "Gas saved", value: "~19%" },
];
...
const BATCH_DETAILS = [
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              {
                tag: "li",
                value: "Specify the amount of ETH you wish to use for this Batch.",
              },
            ],
          },
        ],
                ...
                children: [
                  ...
                  },
                  {
                    ...
                    children: [
                      {
                        tag: "a",
                        value: "Pendle Website",
                        props: {
                          href: "https://app.pendle.finance/points/portfolio",
                          target: "_blank",
  ...
  },
  {
    ...
    children: [
      ...
      {
        tag: "li",
        value: "Security in Batch: Exact approval amount for all token transfer",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      {
        tag: "li",
        value: "Purchase YT ezETH",
      },
      {
        tag: "li",
        value: "Purchase YT rsETH",
      },
    ],
  },
];
