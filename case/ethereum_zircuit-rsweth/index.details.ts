...
export const CASE_PROTOCOLS = [Protocol.Swell, Protocol.Zircuit]
...
export const ATTRIBUTES = [
  ...
  { id: 'gas_saved', name: 'Gas saved', value: '~31%' },
]
...
const BATCH_DETAILS = [
  ...
  },
  {
    ...
    children: [
      {
        tag: 'li',
        value: 'Deposit ETH into Swell restaking smart contract to get $rswETH',
      },
      {
        tag: 'li',
        value: 'Approve $rswETH to Zircuit deposit contract',
      },
      {
        tag: 'li',
        value: 'Deposit $rswETH into Zircuit',
      },
    ],
  },
]
