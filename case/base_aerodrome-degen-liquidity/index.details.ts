...
export const CASE_PROTOCOLS = [Protocol.Aerodrom]
...
export const ATTRIBUTES = [
  ...
  // { id: 'protocols', name: 'Protocols', items: protocolInfo },
...
const BATCH_DETAILS = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        tag: 'li',
        value: 'Provide Liquidity on Aerodrome',
      },
      {
        tag: 'li',
        value: 'Approve LP Token (vAMM-WETH/DEGEN) for framing',
      },
      {
        tag: 'li',
        value: 'Deposit LP token (vAMM-WETH/DEGEN) and start framing',
      },
    ],
  },
]
