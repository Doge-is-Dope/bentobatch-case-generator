...
export const CASE_PROTOCOLS = [Protocol._1inch]
...
export const ATTRIBUTES = [
  ...
  //   items: protocolInfo,
  // },
  { id: 'txn_count', name: 'TXN count', value: '11' },
]
...
const BATCH_DETAILS = [
            ...
            children: [
              {
                tag: 'li',
                value:
                  'Ensure you have USDT & ETH (gas fee) in your Blocto Wallet. Your wallet address can be found in the top right corner.',
              },
              {
                tag: 'li',
                value:
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              {
                tag: 'li',
                value: 'Token allocation for USDT:',
                children: [
                  {
                    tag: 'ul',
                    children: [
                      {
                        tag: 'li',
                        value:
                          'dynamic fetching by top 10 market cap from Coinmarketcap',
                      },
                    ],
                  },
                ],
  ...
  },
  {
    ...
    children: [
      {
        tag: 'li',
        value: 'Approve USDT to 1inch',
      },
      {
        tag: 'li',
        value: 'Swap USDT to Top 10 Ethereum tokes from Coinmarketcap',
      },
    ],
  },
]
